...
export function getBackgroundColorFromName(name) {
    switch (name) {
        case 'Turquoise':
            return 'bg-turquoise';
        case 'Emerald':
...
export function getTextColorFromName(name) {
    switch (name) {
        case 'Turquoise':
...
export function getConstrastColorFromName(name) {
    switch (name) {
        case 'Turquoise':
            return 'text-white';
        case 'Emerald':
...
export function getColorFromName(name, opaque = false) {
