...
import { IApplicationProps } from "../components/globals/Application";

interface IHeaderProps extends IApplicationProps {
    SideBarToggle: boolean;
    OnSideBarToggle: () => void;
}

export const ApplicationHeader: React.FC<IHeaderProps> = (props) => {
    ...
    return (
        <header x-data="{menuToggle: false}" className="sticky top-0 z-99999 flex w-full border-gray-200 bg-white dark:border-gray-800 dark:bg-gray-900 lg:border-b">
            <div className="flex grow flex-col items-center justify-between lg:flex-row lg:px-6">
                <div className="flex w-full items-center justify-between gap-2 border-b border-gray-200 px-3 py-3 dark:border-gray-800 sm:gap-4 lg:justify-normal lg:border-b-0 lg:px-0 lg:py-4">
                    ...
                    <button onClick={() => props.OnSideBarToggle()} className={`${sideBarToggle && 'lg:bg-transparent dark:lg:bg-transparent bg-gray-100 dark:bg-gray-800'} z-99999 flex h-10 w-10 items-center justify-center rounded-lg border-gray-200 text-gray-500 dark:border-gray-800 dark:text-gray-400 lg:h-11 lg:w-11 lg:border cursor-pointer`} >
                        ...
                        <svg className={`${sideBarToggle ? 'hidden' : 'block lg:hidden'} fill-current lg:hidden block`} width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <svg className={`${sideBarToggle ? 'block lg:hidden' : 'hidden'} fill-current`} width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    {/* classHack menuToggle ? 'bg-gray-100 dark:bg-gray-800' : ''" @click.stop="menuToggle = !menuToggle */}
                    <button className="z-99999 flex h-10 w-10 items-center justify-center rounded-lg text-gray-700 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-800 lg:hidden" >
                    ...
                    <div className="hidden lg:block">
                        <form>
                            <div className="relative">
                                ...
                                <input id="search-input" type="text" placeholder="Search or type command..." className="dark:bg-dark-900 h-11 w-full rounded-lg border border-gray-200 bg-transparent py-2.5 pl-12 pr-14 text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-400 focus:border-brand-300 focus:outline-hidden focus:ring-3 focus:ring-brand-500/10 dark:border-gray-800 dark:bg-gray-900 dark:bg-white/[0.03] dark:text-white/90 dark:placeholder:text-white/30 dark:focus:border-brand-800 xl:w-[430px]" />

                                <button id="search-button" className="absolute right-2.5 top-1/2 inline-flex -translate-y-1/2 items-center gap-0.5 rounded-lg border border-gray-200 bg-gray-50 px-[7px] py-[4.5px] text-xs -tracking-[0.2px] text-gray-500 dark:border-gray-800 dark:bg-white/[0.03] dark:text-gray-400">
                                    <span> ⌘ </span>
                                    <span> K </span>
                                </button>
                            </div>
                ...
                {/**classHack menuToggle ? 'flex' : 'hidden'" */}
                <div className="w-full items-center justify-between gap-4 px-5 py-4 shadow-theme-md lg:flex lg:justify-end lg:px-0 lg:shadow-none hidden">
                    <div className="flex items-center gap-2 2xsm:gap-3">
                        ...
                        <button
                            onClick={() => {
                                const isDark = props.applicationTheme === 'dark';
                                props.setTheme?.(!isDark);
                            }}
                        ...
                        <div className="relative" x-data="{ dropdownOpen: false, notifying: true }">
                            ...
                            <button className="hover:text-dark-900 relative flex h-11 w-11 items-center justify-center rounded-full border border-gray-200 bg-white text-gray-500 transition-colors hover:bg-gray-100 hover:text-gray-700 dark:border-gray-800 dark:bg-gray-900 dark:text-gray-400 dark:hover:bg-gray-800 dark:hover:text-white" >
                                {/* classHack !notifying ? 'hidden' : 'flex'"*/}
                                <span className="absolute right-0 top-0.5 z-1 h-2 w-2 rounded-full bg-orange-400 flex">
                            ...
                            <div x-show="dropdownOpen" className="absolute -right-[240px] mt-[17px] flex h-[480px] w-[350px] flex-col rounded-2xl border border-gray-200 bg-white p-3 shadow-theme-lg dark:border-gray-800 dark:bg-gray-dark sm:w-[361px] lg:right-0" style={{ display: 'none' }}>
                                ...
                                <a href="#" className="mt-3 flex justify-center rounded-lg border border-gray-300 bg-white p-3 text-theme-sm font-medium text-gray-700 shadow-theme-xs hover:bg-gray-50 hover:text-gray-800 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-white/[0.03] dark:hover:text-gray-200">
                    ...
                    <div className="relative" x-data="{ dropdownOpen: false }" >
                        ...
                        <a className="flex items-center text-gray-700 dark:text-gray-400" href="#" >
                            <span className="mr-3 h-11 w-11 overflow-hidden rounded-full">
                                <img src="https://randomuser.me/api/portraits/med/men/10.jpg" alt="User" />
                            </span>

                            <span className="mr-1 block text-theme-sm font-medium">{props.user?.firstName}</span>

                            {/**classHack dropdownOpen &amp;&amp; 'rotate-180'" */}
                            <svg className="stroke-gray-500 dark:stroke-gray-400" width="18" height="20" viewBox="0 0 18 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M4.3125 8.65625L9 13.3437L13.6875 8.65625" stroke="" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                            </svg>
                        </a>


                        <div x-show="dropdownOpen" className="absolute right-0 mt-[17px] flex w-[260px] flex-col rounded-2xl border border-gray-200 bg-white p-3 shadow-theme-lg dark:border-gray-800 dark:bg-gray-dark" style={{ display: 'none' }}>
                            <div>
                            ...
                            <button className="group mt-3 flex items-center gap-3 rounded-lg px-3 py-2 text-theme-sm font-medium text-gray-700 hover:bg-gray-100 hover:text-gray-700 dark:text-gray-400 dark:hover:bg-white/5 dark:hover:text-gray-300">
